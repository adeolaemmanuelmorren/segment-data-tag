...
function dataTagSendData(
  ...
  console.log('** inside dataTagSendData **');
  console.log('** arguments');
  console.log('data: ' + data);
  console.log('gtmServerDomain: ' + gtmServerDomain);
  console.log('requestPath: ' + requestPath);
  console.log('dataLayerEventName: ' + dataLayerEventName);
  console.log('dataLayerVariableName: ' + dataLayerVariableName);
  console.log('waitForCookies: ' + waitForCookies);
  console.log('useFetchInsteadOfXHR: ' + useFetchInsteadOfXHR);
  try {
    var replaceVariable = function (a, b) {
      ...
      sendPixel = function (url) {
        ...
        if (
          url.startsWith(
            (gtmServerDomain.charAt(gtmServerDomain.length - 1) === '/'
              ? gtmServerDomain.slice(0, -1)
              : gtmServerDomain) + '/_set_cookie'
          )
        ) {
          ...
          img.onload = img.onerror = function () {
            ...
            setCookieRunningCount--;
            if (
              xhr.readyState === 4 && // server container must be finished to be sure no more cookies will be received
              dataLayerEventName &&
              dataLayerVariableName && // data tag configured to push event
    ...
    if (useFetchInsteadOfXHR) {
        ...
        .then(function (response) {
          response.text().then(function (responseText) {
                ...
                .forEach(function (eventString) {
                  try {
                    const event = JSON.parse(
                      eventString.replace('event: message\ndata: ', '')
                    );
            ...
            if (dataLayerEventName && dataLayerVariableName) {
              // data tag configured to push event
              if (
                !responseText ||
                !responseText.startsWith('event: message\ndata: ')
              ) {
      ...
      xhr.onprogress = function (progress) {
        if (
          ...
          for (
            var replacedResponse = replaceVariable(response, replacements),
            ...
            a: {
              var iterableLines;
              var lines = replacedResponse
                  .substring(0, nextSeparationPos)
                  .split('\n'),
                linesIterator =
              ...
              if (
                eventNameLine.startsWith('event: message') &&
                eventDataLine.startsWith('data: ')
              )
                try {
                  parsedData = JSON.parse(
                    eventDataLine.substring(eventDataLine.indexOf(':') + 1)
                  );
                  break a;
                } catch (e) {}
              parsedData = void 0;
            ...
            replacedResponse = replacedResponse.substring(
              nextSeparationPos + 2
            );
            nextSeparationPos = replacedResponse.indexOf('\n\n');
          }
...
!(function (t, r) {
        ...
        return function (t, r, n) {
          return (function (t, r, n, i) {
            ...
            for (e = 0; e < t.length; e += 2) {
              if (((o = parseInt(t.substr(e, 2), 16)), isNaN(o)))
                throw new Error(
      ...
      case 'B64':
        return function (t, n, i) {
          return (function (t, n, i, e) {
            ...
            if (((t = t.replace(/=/g, '')), -1 !== A && A < t.length))
              throw new Error("Invalid '=' found in base-64 string");
            for (o = 0; o < t.length; o += 4) {
              for (f = t.substr(o, 4), s = 0, u = 0; u < f.length; u += 1)
                s |= r.indexOf(f.charAt(u)) << (18 - 6 * u);
  ...
  function f(t) {
    ...
    if (
      ((r.outputUpper = n.outputUpper || !1),
      n.b64Pad && (r.b64Pad = n.b64Pad),
      n.outputLen)
    ) {
  ...
  function E(t, r) {
    ...
    return (
      ((65535 & ((t >>> 16) + (r >>> 16) + (n >>> 16))) << 16) | (65535 & n)
    );
  }
  function A(t, r, n, i) {
    ...
    for (
      ...
      (F[T] =
        T < 16
          ? t[T]
          : A(
              h((m = F[T - 2]), 17) ^ h(m, 19) ^ a(m, 10),
              F[T - 7],
              d(F[T - 15]),
              F[T - 16]
            )),
        (U = p(y, l(s), c(s, f, R), o[T], F[T])),
        (b = E(v(n), w(n, i, e))),
        (y = R),
        (R = f),
        (f = s),
  ...
  return (function (r) {
    function n(t, n, e) {
      ...
      var u = e || {};
      return (
        ((o = r.call(this, t, n, e) || this).t = o.i),
        (o.o = !0),
        (o.u = -1),
        (o.s = i(o.h, o.v, o.u)),
        (o.A = y),
        ...
        (o.l = R),
        (o.R = function (r, n, i, e) {
          return (function (t, r, n, i, e) {
            for (
              var o, u = 15 + (((r + 65) >>> 9) << 4), s = r + n;
              t.length <= u;
            ...
            for (
              t[r >>> 5] |= 128 << (24 - (r % 32)),
                t[u] = 4294967295 & s,
                t[u - 1] = (s / 4294967296) | 0,
                o = 0;
              o < t.length;
              o += 16
            )
              i = y(t.slice(o, o + 16), i);
            return 'SHA-224' === e
    ...
    (function () {
      ...
      return (
        (t.prototype.update = function (t) {
          ...
          for (r = 0; r < s; r += i)
            n + this.T <= o &&
              ((this.U = this.A(u.slice(r, r + i), this.U)), (n += this.T));
          (this.I += n),
            (this.Y = u.slice(n >>> 5)),
            (this.H = o % this.T),
            (this.S = !0);
        ...
        (t.prototype.getHash = function (t, r) {
          ...
          for (
            i = this.R(this.Y.slice(), this.H, this.I, this.p(this.U), o),
              n = 1;
            n < this.numRounds;
            n += 1
          )
            this.F &&
              ...
              (i = this.R(i, o, 0, this.l(this.g), o));
          return s(i);
        }),
        ...
        (t.prototype.B = function (t) {
          ...
          for (
            n < t.binLen / 8 &&
            (t.value = this.R(t.value, t.binLen, 0, this.l(this.g), this.m));
            t.value.length <= i;

          )
            t.value.push(0);
          for (r = 0; r <= i; r += 1)
            (this.L[r] = 909522486 ^ t.value[r]),
              (this.N[r] = 1549556828 ^ t.value[r]);
        ...
        (t.prototype.i = function () {
          ...
          return (
            (t = this.A(this.N, this.l(this.g))),
            (t = this.R(r, this.m, this.T, t, this.m))
          );
        }),
        t
      );
